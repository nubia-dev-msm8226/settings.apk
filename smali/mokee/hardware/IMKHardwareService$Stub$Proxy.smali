.class Lmokee/hardware/IMKHardwareService$Stub$Proxy;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lmokee/hardware/IMKHardwareService$Stub;
.end annotation
...
.method constructor <init>(Landroid/os/IBinder;)V
    ...
    .line 572
    iput-object p1, p0, Lmokee/hardware/IMKHardwareService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public asBinder()Landroid/os/IBinder;
    ...
    .prologue
    .line 576
    iget-object v0, p0, Lmokee/hardware/IMKHardwareService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public get(I)Z
    ...
    :try_start_0
    const-string/jumbo v3, "mokee.hardware.IMKHardwareService"
    ...
    .line 607
    iget-object v3, p0, Lmokee/hardware/IMKHardwareService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getCurrentDisplayMode()Lmokee/hardware/DisplayMode;
    ...
    .line 872
    sget-object v3, Lmokee/hardware/DisplayMode;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v3, v1}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lmokee/hardware/DisplayMode;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getDefaultPictureAdjustment()Lmokee/hardware/HSIC;
    ...
    .line 1156
    sget-object v3, Lmokee/hardware/HSIC;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .local v2, "_result":Lmokee/hardware/HSIC;
    goto :goto_0

    .line 1162
    .end local v2    # "_result":Lmokee/hardware/HSIC;
    :catchall_0
    move-exception v3
...
.method public getLtoDownloadInterval()J
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string/jumbo v4, "mokee.hardware.IMKHardwareService"

    invoke-virtual {v0, v4}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    .line 801
    iget-object v4, p0, Lmokee/hardware/IMKHardwareService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getTouchscreenGestures()[Lmokee/hardware/TouchscreenGesture;
    ...
    .line 1218
    sget-object v3, Lmokee/hardware/TouchscreenGesture;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, v3}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object v2

    check-cast v2, [Lmokee/hardware/TouchscreenGesture;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 1221
    .local v2, "_result":[Lmokee/hardware/TouchscreenGesture;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 1220
    .end local v2    # "_result":[Lmokee/hardware/TouchscreenGesture;
    :catchall_0
    move-exception v3
...
.method public registerThermalListener(Lmokee/hardware/IThermalListenerCallback;)Z
    .locals 6
    .param p1, "callback"    # Lmokee/hardware/IThermalListenerCallback;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
    ...
    invoke-interface {p1}, Lmokee/hardware/IThermalListenerCallback;->asBinder()Landroid/os/IBinder;
...
.method public setDisplayMode(Lmokee/hardware/DisplayMode;Z)Z
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string/jumbo v5, "mokee.hardware.IMKHardwareService"
    ...
    invoke-virtual {p1, v0, v5}, Lmokee/hardware/DisplayMode;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public setPictureAdjustment(Lmokee/hardware/HSIC;)Z
    ...
    invoke-virtual {p1, v0, v3}, Lmokee/hardware/HSIC;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public setTouchscreenGestureEnabled(Lmokee/hardware/TouchscreenGesture;Z)Z
    ...
    invoke-virtual {p1, v0, v5}, Lmokee/hardware/TouchscreenGesture;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public unRegisterThermalListener(Lmokee/hardware/IThermalListenerCallback;)Z
    .locals 6
    .param p1, "callback"    # Lmokee/hardware/IThermalListenerCallback;
    .annotation system Ldalvik/annotation/Throws;
        value = {
