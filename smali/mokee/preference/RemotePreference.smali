.class public Lmokee/preference/RemotePreference;
.super Lmokee/preference/SelfRemovingPreference;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 64
    const-class v0, Lmokee/preference/RemotePreference;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lmokee/preference/RemotePreference;->TAG:Ljava/lang/String;

    .line 66
    sget-object v0, Lmokee/preference/RemotePreference;->TAG:Ljava/lang/String;
    ...
    sput-boolean v0, Lmokee/preference/RemotePreference;->DEBUG:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lmokee/preference/RemotePreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lmokee/preference/RemotePreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1, p2, p3, p4}, Lmokee/preference/SelfRemovingPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    .line 89
    iput-object p1, p0, Lmokee/preference/RemotePreference;->mContext:Landroid/content/Context;
...
.method public getReceiverIntent()Landroid/content/Intent;
    ...
    .line 137
    invoke-virtual {p0}, Lmokee/preference/RemotePreference;->getIntent()Landroid/content/Intent;
    ...
    .line 139
    sget-object v11, Lmokee/preference/RemotePreference;->TAG:Ljava/lang/String;
    ...
    .line 143
    :cond_0
    iget-object v11, p0, Lmokee/preference/RemotePreference;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v2}, Lmokee/preference/RemotePreference;->getRemoteKey(Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object v6

    .line 166
    .local v6, "remoteKey":Ljava/lang/String;
    sget-boolean v11, Lmokee/preference/RemotePreference;->DEBUG:Z
    ...
    const-string/jumbo v11, "mokee.intent.action.UPDATE_PREFERENCE"
    ...
    .line 175
    const-string/jumbo v11, ":mk:pref_key"
...
.method protected getRemoteKey(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lmokee/preference/RemotePreference;->getKey()Ljava/lang/String;
...
.method public onAttached()V
    ...
    .prologue
    .line 118
    invoke-super {p0}, Lmokee/preference/SelfRemovingPreference;->onAttached()V

    .line 119
    invoke-virtual {p0}, Lmokee/preference/RemotePreference;->isAvailable()Z
    ...
    .line 120
    iget-object v0, p0, Lmokee/preference/RemotePreference;->mContext:Landroid/content/Context;
...
.method public onDetached()V
    ...
    .prologue
    .line 126
    invoke-super {p0}, Lmokee/preference/SelfRemovingPreference;->onDetached()V
...
.method public onRemoteUpdated(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 103
    sget-boolean v1, Lmokee/preference/RemotePreference;->DEBUG:Z

    if-eqz v1, :cond_0

    sget-object v1, Lmokee/preference/RemotePreference;->TAG:Ljava/lang/String;
    ...
    .line 105
    :cond_0
    const-string/jumbo v1, ":mk:pref_enabled"
    ...
    .line 108
    invoke-virtual {p0, v0}, Lmokee/preference/RemotePreference;->setAvailable(Z)V
    ...
    invoke-virtual {p0, v1}, Lmokee/preference/RemotePreference;->setSummary(Ljava/lang/CharSequence;)V
