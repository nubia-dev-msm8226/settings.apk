...
.method static synthetic -wrap0(Lcom/android/settings/applications/AppOpsDetails;I)I
    .locals 1
    .param p1, "position"    # I
...
.method private isPlatformSigned()Z
    ...
    .line 95
    iget-object v2, p0, Lcom/android/settings/applications/AppOpsDetails;->mPm:Landroid/content/pm/PackageManager;

    const-string/jumbo v3, "android"

    iget-object v4, p0, Lcom/android/settings/applications/AppOpsDetails;->mPackageInfo:Landroid/content/pm/PackageInfo;
...
.method private refreshUi()Z
    ...
    .line 142
    .local v9, "isPlatformSigned":Z
    sget-object v23, Lcom/android/settings/applications/AppOpsState;->ALL_TEMPLATES:[Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    ...
    aget-object v19, v23, v22

    .line 147
    .local v19, "tpl":Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    if-eqz v9, :cond_2

    sget-object v21, Lcom/android/settings/applications/AppOpsState;->SU_TEMPLATE:Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    ...
    .line 175
    invoke-virtual {v6, v15}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->getCountsText(Landroid/content/res/Resources;)Ljava/lang/CharSequence;
    ...
    .line 180
    .local v16, "sp":Landroid/widget/Spinner;
    const/16 v21, 0x8
    ...
    invoke-virtual/range {v25 .. v25}, Landroid/app/AppOpsManager$PackageOps;->getUid()I
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/app/AppOpsManager$PackageOps;->getPackageName()Ljava/lang/String;
    ...
    invoke-direct {v0, v11}, Lcom/android/settings/applications/AppOpsDetails;->modeToPosition(I)I
    ...
    .line 210
    new-instance v21, Lcom/android/settings/applications/AppOpsDetails$2;
    ...
    .line 220
    invoke-static/range {v18 .. v18}, Landroid/app/AppOpsManager;->isStrictOp(I)Z
    ...
    .end local v16    # "sp":Landroid/widget/Spinner;
    .end local v17    # "sw":Landroid/widget/Switch;
    .end local v18    # "switchOp":I
    .restart local v14    # "pi":Landroid/content/pm/PermissionInfo;
    :cond_4
    :try_start_1
    ...
    .restart local v16    # "sp":Landroid/widget/Spinner;
    .restart local v17    # "sw":Landroid/widget/Switch;
    .restart local v18    # "switchOp":I
    :cond_5
    const/16 v21, 0x0
...
.method private setAppLabelAndIcon(Landroid/content/pm/PackageInfo;)V
    ...
    .line 104
    :goto_0
    invoke-static {v0, v2, v1, v3, v4}, Lcom/android/settings/applications/InstalledAppDetails;->setupAppSnippet(Landroid/view/View;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Ljava/lang/String;)V
