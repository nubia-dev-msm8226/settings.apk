...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/applications/ProtectedAppsActivity$1;,
...
# direct methods
.method static synthetic -get0(Lcom/android/settings/applications/ProtectedAppsActivity;)Landroid/view/View$OnClickListener;
    .locals 1
...
.method static synthetic -get1(Lcom/android/settings/applications/ProtectedAppsActivity;)Lcom/android/settings/applications/ProtectedAppsActivity$AppsAdapter;
    .locals 1
...
.method static synthetic -get2(Lcom/android/settings/applications/ProtectedAppsActivity;)Landroid/content/pm/PackageManager;
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/settings/applications/ProtectedAppsActivity;Landroid/content/ComponentName;)Z
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/settings/applications/ProtectedAppsActivity;)Ljava/util/List;
    .locals 1
...
.method static synthetic -wrap2(Lcom/android/settings/applications/ProtectedAppsActivity;)V
    .locals 0
...
.method public constructor <init>()V
    ...
    .line 73
    iput-boolean v0, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mUserIsAuth:Z
...
.method private launchTargetActivityInfoAndFinish()V
    ...
    .prologue
    .line 211
    iget-object v0, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mTargetIntent:Landroid/content/Intent;

    .line 212
    .local v0, "launchIntent":Landroid/content/Intent;
    invoke-virtual {p0, v0}, Lcom/android/settings/applications/ProtectedAppsActivity;->startActivity(Landroid/content/Intent;)V
...
.method private refreshApps()Ljava/util/List;
    ...
    invoke-direct {v5, p0, v2}, Lcom/android/settings/applications/ProtectedAppsActivity$AppEntry;-><init>(Lcom/android/settings/applications/ProtectedAppsActivity;Landroid/content/pm/ResolveInfo;)V
...
.method private reset()V
    ...
    .line 232
    invoke-static {v5, v7}, Lmokee/providers/MKSettings$Secure;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 245
    :cond_0
    new-instance v4, Lcom/android/settings/applications/ProtectedAppsActivity$AppProtectList;

    invoke-direct {v4, p0, v1, v12}, Lcom/android/settings/applications/ProtectedAppsActivity$AppProtectList;-><init>(Lcom/android/settings/applications/ProtectedAppsActivity;Ljava/util/ArrayList;Z)V

    .line 247
    .local v4, "list":Lcom/android/settings/applications/ProtectedAppsActivity$AppProtectList;
    new-instance v6, Lcom/android/settings/applications/ProtectedAppsActivity$StoreComponentProtectedStatus;

    invoke-direct {v6, p0, p0}, Lcom/android/settings/applications/ProtectedAppsActivity$StoreComponentProtectedStatus;-><init>(Lcom/android/settings/applications/ProtectedAppsActivity;Landroid/content/Context;)V

    .line 248
    .local v6, "task":Lcom/android/settings/applications/ProtectedAppsActivity$StoreComponentProtectedStatus;
    new-array v7, v12, [Lcom/android/settings/applications/ProtectedAppsActivity$AppProtectList;

    aput-object v4, v7, v8

    invoke-virtual {v6, v7}, Lcom/android/settings/applications/ProtectedAppsActivity$StoreComponentProtectedStatus;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    .line 225
    return-void

    .line 236
    .end local v4    # "list":Lcom/android/settings/applications/ProtectedAppsActivity$AppProtectList;
    .end local v6    # "task":Lcom/android/settings/applications/ProtectedAppsActivity$StoreComponentProtectedStatus;
    :cond_1
    const-string/jumbo v7, "\\|"
...
.method private updateProtectedComponentsList()V
    ...
    .line 156
    invoke-static {v4, v5}, Lmokee/providers/MKSettings$Secure;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v4, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mProtectedApps:Ljava/util/HashSet;
    ...
    .line 164
    iget-object v6, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mProtectedApps:Ljava/util/HashSet;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 195
    invoke-direct {p0}, Lcom/android/settings/applications/ProtectedAppsActivity;->launchTargetActivityInfoAndFinish()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 84
    invoke-virtual {p0}, Lcom/android/settings/applications/ProtectedAppsActivity;->getIntent()Landroid/content/Intent;
    ...
    .line 86
    iput-object v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mTargetIntent:Landroid/content/Intent;

    .line 91
    :cond_0
    const v2, 0x7f0c025a

    invoke-virtual {p0, v2}, Lcom/android/settings/applications/ProtectedAppsActivity;->setTitle(I)V

    .line 92
    const v2, 0x7f04008f

    invoke-virtual {p0, v2}, Lcom/android/settings/applications/ProtectedAppsActivity;->setContentView(I)V
    ...
    iput-object v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mPackageManager:Landroid/content/pm/PackageManager;

    .line 95
    new-instance v2, Lcom/android/settings/applications/ProtectedAppsActivity$AppsAdapter;

    const v3, 0x7f040090

    invoke-direct {v2, p0, p0, v3}, Lcom/android/settings/applications/ProtectedAppsActivity$AppsAdapter;-><init>(Lcom/android/settings/applications/ProtectedAppsActivity;Landroid/content/Context;I)V

    iput-object v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mAppsAdapter:Lcom/android/settings/applications/ProtectedAppsActivity$AppsAdapter;
    ...
    invoke-virtual {v2, v4}, Lcom/android/settings/applications/ProtectedAppsActivity$AppsAdapter;->setNotifyOnChange(Z)V

    .line 98
    const v2, 0x7f110151

    invoke-virtual {p0, v2}, Lcom/android/settings/applications/ProtectedAppsActivity;->findViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, Landroid/widget/ListView;

    iput-object v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mListView:Landroid/widget/ListView;

    .line 99
    iget-object v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mListView:Landroid/widget/ListView;

    iget-object v3, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mAppsAdapter:Lcom/android/settings/applications/ProtectedAppsActivity$AppsAdapter;
    ...
    iput-object v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mProtect:Ljava/util/ArrayList;
    ...
    iput-boolean v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mUserIsAuth:Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0}, Lcom/android/settings/applications/ProtectedAppsActivity;->getResources()Landroid/content/res/Resources;
    ...
    iput v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mOrientation:I
    ...
    .line 107
    :cond_2
    iget-boolean v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mUserIsAuth:Z

    if-nez v2, :cond_3

    .line 109
    iput-boolean v4, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mWaitUserAuth:Z
    ...
    invoke-virtual {p0, v1, v4}, Lcom/android/settings/applications/ProtectedAppsActivity;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    :cond_3
    iget-object v2, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mTargetIntent:Landroid/content/Intent;
...
.method public onPause()V
    ...
    iget v0, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mOrientation:I
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mUserIsAuth:Z
    ...
    iget-object v1, p0, Lcom/android/settings/applications/ProtectedAppsActivity;->mTargetIntent:Landroid/content/Intent;
